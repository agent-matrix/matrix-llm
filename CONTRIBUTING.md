# Contributing to MatrixLLM

Thank you for considering contributing to MatrixLLM! 🎉
...
4. Your environment (OS, Python version, MatrixLLM version)
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/matrixllm.git
cd matrixllm
...
pytest --cov=matrixllm --cov-report=html
```
...
**Thank you for making MatrixLLM better!** 🚀
