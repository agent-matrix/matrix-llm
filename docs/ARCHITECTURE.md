# 🏗️ MatrixLLM Architecture

**Understanding how MatrixLLM works under the hood**

---

## Overview

MatrixLLM uses a **Control Plane + Node Agent** architecture where:
...
**Location:** `src/matrixllm/api/main.py`
...
**Location:** `src/matrixllm/core/registry.py`
...
**Location:** `src/matrixllm/core/router.py`
...
**Location:** `src/matrixllm/api/relay.py`
...
**Location:** `src/matrixllm/connectors/direct_endpoint.py`
...
**Location:** Built-in to `src/matrixllm/api/main.py`
...
**Location:** `src/matrixllm/core/security.py`
...
**Location:** `src/matrixllm/core/enrollment.py`
...
**Flow:**
```
1. Admin creates token: matrixllm enroll-create
2. Admin shares token with node operator
3. Node uses token to join: matrixllm-node join --token ...
...
```
1. Start: matrixllm-node join --control ... --token ...
   │
...
1. Create `src/matrixllm/connectors/my_connector.py`
...
1. Create `src/matrixllm/node/runtimes/my_runtime.py`
...
**Q: Can I use MatrixLLM without nodes?**
...
**Questions?** [Open an issue](https://github.com/ruslanmv/matrixllm/issues) or [start a discussion](https://github.com/ruslanmv/matrixllm/discussions)!
