...
documents = [
    "MatrixLLM is an OpenAI-compatible gateway for local LLMs.",
    "You can add remote GPUs by running matrixllm-node join.",
...
try:
    ...
    print("Cannot connect to MatrixLLM. Is it running?")
...
- 💬 [Ask in Discussions](https://github.com/ruslanmv/matrixllm/discussions)

---

**Next:** Check out [ARCHITECTURE.md](ARCHITECTURE.md) to understand how MatrixLLM works under the hood.
